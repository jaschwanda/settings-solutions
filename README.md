...
The usi-settings module is a helper class used by various WordPress plugins developed by Universal Solutions.

## Installation ##
This module should be installed in the usi-settings sub-folder of the main plugin folder.
